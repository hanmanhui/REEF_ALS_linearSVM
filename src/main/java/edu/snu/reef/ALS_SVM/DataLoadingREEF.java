...
public class DataLoadingREEF {
	...
	public static void main(final String[] args) 
		...
		new CommandLine(cb).registerShortNameOfClass(Local.class)
		...
		final LauncherStatus state = DriverLauncher.getLauncher(
				runtimeConfiguration).run(dataLoadConfiguration, jobTimeout);
